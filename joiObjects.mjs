...
export const arrayMedecinInstamed = Joi.array().items(medecinInstamed).description('Array of practitioners');
...
export const arrayMedecin = Joi.array().items(medecin).description('Array of practitioners');
